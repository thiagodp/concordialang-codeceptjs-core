...
export declare enum CmdCmp {
    ...
    SAME_MODIFIER__SAME_OPTION__ONE_TARGET__TWO_VALUES = 62,
    SAME_MODIFIER__SAME_OPTION__SAME_TARGET_TYPE__ONE_TARGET = 63,
    SAME_MODIFIER__SAME_TARGET_TYPE__ONE_VALUE = 64,
    SAME_MODIFIER__SAME_TARGET_TYPE__ONE_VALUE_OR_NUMBER = 65,
    SAME_MODIFIER__SAME_TARGET_TYPE__ONE_TARGET__ONE_VALUE = 66,
    SAME_MODIFIER__SAME_TARGET_TYPE__ONE_TARGET__ONE_VALUE_OR_NUMBER = 67,
    TWO_TARGETS = 68,
    TWO_VALUES_SAME_OPTION = 69,
    TWO_NUMBERS = 70,
    TWO_NUMBERS_SAME_OPTION = 71,
    TWO_NUMBERS_SAME_TARGET_TYPE = 72
}
